...
diesel::table! {
    collections_v2 (transaction_version, write_set_change_index) {
        ...
        mutable_token_maximum_v1 -> Nullable<Bool>,
...
diesel::table! {
    current_token_ownerships_v2 (token_data_id, property_version_v1, owner_address, wallet_address) {
        token_data_id -> Varchar,
        ...
        token_properties_mutated_v1 -> Nullable<Varchar>,
        token_standard -> Varchar,

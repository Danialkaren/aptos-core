...
CREATE TABLE IF NOT EXISTS token_ownerships_v2 (
  ...
  token_properties_mutated_v1 VARCHAR(66),
...
CREATE INDEX IF NOT EXISTS curr_to2_wa_index ON current_token_ownerships_v2 (wallet_address);
...
CREATE TABLE IF NOT EXISTS collections_v2 (
  ...
  mutable_token_maximum_v1 BOOLEAN,
  mutable_token_uri BOOLEAN NOT NULL,
  mutable_token_description BOOLEAN NOT NULL,
  mutable_token_properties BOOLEAN NOT NULL,
  mutable_token_name BOOLEAN NOT NULL,
  token_standard VARCHAR(10) NOT NULL,
  transaction_timestamp TIMESTAMP NOT NULL,
  inserted_at TIMESTAMP NOT NULL DEFAULT NOW(),
  PRIMARY KEY (transaction_version, write_set_change_index)
